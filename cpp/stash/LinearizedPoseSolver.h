...
public:
  ...
  /**
   * when all vertices is active, the pivot hold the information of absolute
   * coordinates, according to which the graph is rearranged after optimization
...
private:
  ...
  struct Measurement {
    Measurement(IDType i, IDType j, MeasurementType mij, double _wt = 1.,
                double _wr = 1., double _ws = 1.)
